...
export default {
              ...
              h(
                "el-button",
                {
                  props: {
                    ...
                    type: "text",
                    disabled:
                      rowData.status !== 3 || rowData.driver_user_name !== null
                  },
                  on: {
  ...
  async mounted() {
    ...
    const violationCategoryJSON = await this.$http({
  ...
  methods: {
    ...
    assignDrivers() {
      const chooseDatas = this.$refs["forensics-list"].dataListSelections;
                    ...
                    ids
                      .map(a =>
                        this.bicycleProviderList.find(
                          b => b.bicycleProviderId.toString() === a
                        )
                      )
                      .map(a =>
                        h("el-tag", { style: "margin-right:10px" }, a.name)
                      )
                  );
                }
              },
              {
                ...
                render: (h, params) => {
                  ...
                  return h(
                    ...
                    ids
                      .map(a =>
                        this.violationCategoryList.find(
                          b => b.id.toString() === a
                        )
                      )
                      .map(a =>
